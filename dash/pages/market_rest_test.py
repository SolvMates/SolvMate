...
dash.register_page(
    __name__,
    path="/Market/market-rest-test",
    title='Market (w/o ConcR & Curr)',
    name='Market (w/o ConcR & Curr)',
...
def layout():
    ...
    return dbc.Container([
        # Header section
        html.H1("Market (w/o ConcR & Curr)", className="my-4"),
        ...
        dbc.Tabs([
            ...
            dbc.Tab(label="Perform calculation", tab_id="perform-calculation", children=[
                ...
                html.Div(id="status-area_market_rest", className="mt-3")
            ], className="p-3"),
...
@callback(
    Output("status-area_market_rest", "children"),
